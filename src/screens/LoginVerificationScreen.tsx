...
interface LoginVerificationScreenProps {
  email: string;
  userId: string;
  onVerificationSuccess?: (accessToken: string, refreshToken: string) => void;
  onResendCode?: () => void;
}
...
export function LoginVerificationScreen({
  ...
  const verifyMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      onVerificationSuccess?.(data.access_token, data.refresh_token);
    },
    onError: (error: any) => {
    ...
    >
      <View style={styles.card}>
        <View style={styles.header}>
          <Text style={styles.title}>Verificatiecode</Text>
